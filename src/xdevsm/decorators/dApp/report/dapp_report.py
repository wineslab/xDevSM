...
from xdevsm.utils.lat_profile import lat_log
...
import xdevsm.sm_framework.py_oran.dapp.report.DAppIndicationHdr as DAppIndicationHdr
import xdevsm.sm_framework.py_oran.dapp.report.DAppIndicationMsg as DAppIndicationMsg
import xdevsm.sm_framework.py_oran.dapp.e3.DAppE3IndPayload as DAppE3IndPayload
import xdevsm.sm_framework.py_oran.dapp.report.DAppActionDef as DAppActionDef
import xdevsm.sm_framework.py_oran.dapp.report.DAppEvTrigger as DAppEvTrigger
import xdevsm.sm_framework.py_oran.dapp.report.DAppFunctionDef as dappfuncdef
...
class DAppReport(xAppReportService):
    ...
    def subscribe(self, gnb, ev_trigger: DAppEvTrigger.DAppEvTrigger=None, action_def_in: int=None):
        """
