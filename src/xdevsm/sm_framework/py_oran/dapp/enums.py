...
class e2sm_dapp_action_def_format_e(ctypes.c_uint):
    FORMAT_1_E2SM_DAPP_ACTION_DEF = 0
    END_E2SM_DAPP_ACTION_DEF = 1

class e2sm_dapp_ind_hdr_format_e(ctypes.c_uint):
    FORMAT_1_E2SM_DAPP_IND_HDR = 0
    FORMAT_2_E2SM_DAPP_IND_HDR = 1
    END_E2SM_DAPP_IND_HDR = 2

class e2sm_dapp_ev_trigger_format_e(ctypes.c_uint):
    FORMAT_1_E2SM_DAPP_EV_TRIGGER_FORMAT = 0
    END_E2SM_DAPP_EV_TRIGGER_FORMAT = 1

class e2sm_dapp_ind_msg_format_e(ctypes.c_uint):
    FORMAT_1_E2SM_DAPP_IND_MSG = 0
    FORMAT_2_E2SM_DAPP_IND_MSG = 1
    END_E2SM_DAPP_IND_MSG = 2
